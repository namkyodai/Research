...
#     03.x-Wearoutx, define life time of the object and calculate Markov transition probability, using solver
#     03.x-Px, copy the Markov transition probability into this file and define the initial condition state for the object
