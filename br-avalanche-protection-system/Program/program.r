...
legend("topright", inset=0.09, title="states",col=colors,lty=2,lwd=13,legend=c("i=1","i=2","i=3","i=4","i=5","l=1"),bg="azure2",cex=1.2)
...
text(T_optimal*0.9, Min_C/factor*1.5,"A(19, 6.59)",pos=4,cex = 1, srt = 0)
